...
def demutiplex_individuals(options_dict):
    ...
    Message.print('trace', 'index1 start: {0}'.format(index1_start))

    # get the index2 start position in the cend_seq
    index2_final = cend_seq.find(index2_symbol * index2len)
    Message.print('trace', 'index2 final: {0}'.format(index2_final))
        ...
        if readtype == 'SE':
            ...
            while record1 != '':
                ...
                if technique in ['IND1', 'IND1_DBR']:
                    ...
                    individual_key = 'ERRORS'
                Message.print('trace', 'individual_key: {0}'.format(individual_key))
    ...
    if readtype == 'SE': 
        Message.print('info', 'The files {0}_<individual_id>{1} containing the individuals data are created.'.format(get_file_name_noext(readsfile1), extension))
    elif readtype == 'PE':
        Message.print('info', 'The files {0}-<individual_id>{2} and {1}-<individual_id>{2} containing the individuals data are created.'.format(get_file_name_noext(readsfile1), get_file_name_noext(readsfile2), extension))
...
def print_help(options_dict):
    ...
    Message.print('info', '')
    Message.print('info', '{0} ...'.format(program_file))
    Message.print('info', '')
    ...
    Message.print('info', '')
    Message.print('info', '       {0:17}   {1}'.format('option', 'value'))
    Message.print('info', '       {0:17}   {1}'.format('=' * 13, '=' * 95))
    Message.print('info', '       {0:17}   {1}'.format('--technique', options_dict['technique']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--format', options_dict['format']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--readtype', options_dict['readtype']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--endsfile', options_dict['endsfile']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--index1len', options_dict['index1len']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--index2len', options_dict['index2len']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--dbrlen', options_dict['dbrlen']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--wend', options_dict['wend']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--cend', options_dict['cend']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--individualsfile', options_dict['individualsfile']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--readsfile1', options_dict['readsfile1']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--readsfile2', options_dict['readsfile2']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--verbose', options_dict['verbose']['comment']))
    Message.print('info', '       {0:17}   {1}'.format('--trace', options_dict['trace']['comment']))
...
def build_config(options_dict):
    ...
    # show OK message 
    Message.print('info', 'The configuration file {0} has been created.'.format(get_file_name(config_file)))
