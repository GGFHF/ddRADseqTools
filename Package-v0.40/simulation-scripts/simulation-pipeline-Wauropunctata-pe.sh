...
# This script generates fragments from the Wasmannia auropunctata genome; it
...
# demultiplexes the individuals; it trims the adapters and other Illumina specific
# sequences; it aligns the reads and gets SAM, BAM, BED and VCF format files to
# study and visualize alignments; and it gets the distinct loci list with mutations.
...
GENOME=GCF_000956235.1_wasmannia.A_1.0_genomic.fna.gz    # Wasmannia auropunctata genome
...
WEND=end93
CEND=end94
INDIVIDUALSFILE=individuals-1index1-5index2.txt
