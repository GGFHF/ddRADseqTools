...
# This script generates fragments from the Brassica napus genome, simulates
# a double digest, generates their PE reads, demultiplexes the individuals,
# trims the adapters and other Illumina specific sequences, aligns the reads
# and gets SAM, BAM, BED and VCF format files to study and visualize
# alignments
...
GENOME=GCF_000686985.1_Brassica_napus_assembly_v1.0_genomic.fna.gz    # Brassica napus genome
...
WEND=end73
CEND=end74
INDIVIDUALSFILE=individuals-19index1-10index2.txt
